...
use App\Models\Work; use Illuminate\Support\Str;
readonly class KdpPublicationPayload {
    ...
    public function toArray(): array { return ['title' => $this->title, 'description' => $this->description, 'language' => $this->language, 'categories' => $this->categories, 'format' => $this->format, 'pricing' => $this->pricing, 'files' => array_filter(['manuscript' => $this->manuscriptPath, 'cover' => $this->coverPath])]; }
}
